...
use Illuminate\Support\Facades\DB; // IMPORTANTE: Para usar Transacciones de Base de Datos
...
class RecepcionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'detalles' => 'required|array|min:1', // Debe haber al menos un producto
        ...
        try {
            ...
            foreach ($validatedData['detalles'] as $detalle) {
                RecepcionDetalle::create([
                    'recepcion_id' => $recepcion->id, // Lo atamos al ID que acabamos de crear
